...
-- put data into stage
put
file://C:\Projects\data_engineering\Saylani cloud data engineering\cloud-data-engineering\batch 05 - Haniya Maqsood\Section 6 - Snowflake & DBT\Snowflake - Data Loading\data\customer_detail.csv
...
CREATE OR REPLACE STAGE S3_INTEGRATEION_BULK_COPY_TESLA_STOCKS
  ...
  URL = 'snowflake-s3-data-loading/TSLA.csv'
  FILE_FORMAT = (TYPE = 'CSV', FIELD_DELIMITER=',', SKIP_HEADER=1);

-- validating integration
LIST @S3_INTEGRATEION_BULK_COPY_TESLA_STOCKS;

-- since file format is already defined in the stage, we can use the copy command without specifying the file format again
